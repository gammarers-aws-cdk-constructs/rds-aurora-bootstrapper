...
### AuroraDatabaseCreateMigrator <a name="AuroraDatabaseCreateMigrator" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator"></a>

CDK construct that provisions a PostgreSQL migrator user on an Aurora cluster using a custom resource backed by the RDS Data API.
...
#### Initializers <a name="Initializers" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.Initializer"></a>

```typescript
import { AuroraDatabaseCreateMigrator } from 'rds-aurora-bootstrapper'

new AuroraDatabaseCreateMigrator(scope: Construct, id: string, props: AuroraDatabaseCreateMigratorProps)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.Initializer.parameter.scope">scope</a></code> | <code>constructs.Construct</code> | - Parent construct. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.Initializer.parameter.id">id</a></code> | <code>string</code> | - Construct identifier. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.Initializer.parameter.props">props</a></code> | <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps">AuroraDatabaseCreateMigratorProps</a></code> | - Configuration for the migrator user. |

---

##### `scope`<sup>Required</sup> <a name="scope" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.Initializer.parameter.scope"></a>
...
##### `id`<sup>Required</sup> <a name="id" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.Initializer.parameter.id"></a>
...
##### `props`<sup>Required</sup> <a name="props" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.Initializer.parameter.props"></a>

- *Type:* <a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps">AuroraDatabaseCreateMigratorProps</a>

Configuration for the migrator user.
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.toString">toString</a></code> | Returns a string representation of this construct. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.with">with</a></code> | Applies one or more mixins to this construct. |

---

##### `toString` <a name="toString" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.toString"></a>
...
##### `with` <a name="with" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.with.parameter.mixins"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.isConstruct">isConstruct</a></code> | Checks if `x` is a construct. |

---

##### `isConstruct` <a name="isConstruct" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.isConstruct"></a>

```typescript
import { AuroraDatabaseCreateMigrator } from 'rds-aurora-bootstrapper'

AuroraDatabaseCreateMigrator.isConstruct(x: any)
```
...
###### `x`<sup>Required</sup> <a name="x" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.isConstruct.parameter.x"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.property.node">node</a></code> | <code>constructs.Node</code> | The tree node. |

---

##### `node`<sup>Required</sup> <a name="node" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigrator.property.node"></a>
...
### AuroraDatabaseCreateMigratorProps <a name="AuroraDatabaseCreateMigratorProps" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps"></a>

Properties for {@link AuroraDatabaseCreateMigrator}.

#### Initializer <a name="Initializer" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.Initializer"></a>

```typescript
import { AuroraDatabaseCreateMigratorProps } from 'rds-aurora-bootstrapper'

const auroraDatabaseCreateMigratorProps: AuroraDatabaseCreateMigratorProps = { ... }
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.dbCluster">dbCluster</a></code> | <code>aws-cdk-lib.aws_rds.DatabaseCluster</code> | Aurora database cluster where the migrator role is created. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.dbMasterUserCredentials">dbMasterUserCredentials</a></code> | <code>aws-cdk-lib.aws_secretsmanager.Secret</code> | Secrets Manager secret holding the Aurora master user credentials. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.dbName">dbName</a></code> | <code>string</code> | Name of the PostgreSQL database targeted by the custom resource. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.migratorUserCredentials">migratorUserCredentials</a></code> | <code>aws-cdk-lib.aws_secretsmanager.Secret</code> | Secrets Manager secret holding the migrator user credentials. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.ownerUsername">ownerUsername</a></code> | <code>string</code> | Username of the existing owner role granted to the migrator. |
| <code><a href="#rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.schemaName">schemaName</a></code> | <code>string</code> | Name of the PostgreSQL schema used as the migrator's `search_path`. |

---

##### `dbCluster`<sup>Required</sup> <a name="dbCluster" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.dbCluster"></a>
...
##### `dbMasterUserCredentials`<sup>Required</sup> <a name="dbMasterUserCredentials" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.dbMasterUserCredentials"></a>
...
##### `dbName`<sup>Required</sup> <a name="dbName" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.dbName"></a>
...
##### `migratorUserCredentials`<sup>Required</sup> <a name="migratorUserCredentials" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.migratorUserCredentials"></a>

```typescript
public readonly migratorUserCredentials: Secret;
```
...
##### `ownerUsername`<sup>Required</sup> <a name="ownerUsername" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.ownerUsername"></a>
...
##### `schemaName`<sup>Required</sup> <a name="schemaName" id="rds-aurora-bootstrapper.AuroraDatabaseCreateMigratorProps.property.schemaName"></a>
