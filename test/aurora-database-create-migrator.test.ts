...
import { AuroraDatabaseCreateMigrator } from '../src';

describe('AuroraDatabaseCreateMigrator', () => {
  test('matches snapshot', () => {
    ...
    const migratorUserSecret = new Secret(stack, 'MigratorUserSecret');

    new AuroraDatabaseCreateMigrator(stack, 'CreateMigrator', {
  ...
  test('throws when ownerUsername is invalid', () => {
    ...
    expect(() => new AuroraDatabaseCreateMigrator(stack, 'CreateMigrator', {
      dbMasterUserCredentials: masterUserSecret,
      migratorUserCredentials: migratorUserSecret,
      dbCluster: cluster,
      dbName: 'appdb',
